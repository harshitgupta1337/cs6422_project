...
def get_prob_changed(server_idx, trans_start_ts, trans_idx, latencies, auto_rate):
    if server_idx not in server_last_update_ts.keys():
        ...
        window = server_last_update_ts[server_idx] + server_last_latency_sample[server_idx] + latencies[0]
...
def main():
    ...
    while trans_idx < num_transactions:
        ...
        print ("Trans execn latency  for trans ", trans_idx, " = ", trans_execn_latency)
