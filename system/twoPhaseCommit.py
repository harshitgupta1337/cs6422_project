...
class twoPhaseCommit:
    ...
    def submitTransaction (self, t):
        ...
        'Step 1: Send txn to the set of servers. Im assuming the set of servers is a list'
        for task in t.tasks:
    ...
    def txnSuccessCallback(self):
        'Txn was completed by server, send (serverAddress, AGREE) msg to controller'
        pass
    ...
    def txnFailCallback(self):
        'Txn wasnt completed by server, send (serverAddress, DISAGREE) to controller'
        pass
    
    def onRecvMsg(self, msg_src, cp_msg):
...
if __name__ == "__main__":
    ...
    for i in range(num_tasks):
        ...
        cp_2pc.onRecvMsg(server, cp_msg)
